...
Use this guide when adding or updating a News post in Pages CMS.

## Where to go

1. Open [Pages CMS](https://app.pagescms.org/).
2. Sign in with GitHub.
3. Open the `Wish Upon a Fish` repository.
4. Click the `News` collection.
...
1. Open the post from the `News` list.
